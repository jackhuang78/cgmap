...
data class GraphicInfo(
    ...
    fun validate(): GraphicInfo {
        ...
        checkState(mapNo >= 0, "Expect non-negative graphicId, but got ${mapNo}.")
        return this
    }
}
...
data class MapTileInfo(
        val ground: GraphicInfo,
        val item: GraphicInfo,
        val mark: Int,
        val border: Boolean,
        val loc: Point
)
