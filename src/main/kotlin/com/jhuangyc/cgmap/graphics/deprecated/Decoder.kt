	...
	override fun iterator(): Iterator<Int> {
		...
		return object : Iterator<Int> {
			...
			override fun next(): Int {
				input = {
					val b0 = if (output.idx + 0 < data.capacity()) data.get(
							output.idx + 0) else 0
					Input(
							state = output.state,
							idx = output.idx,
							...
							b0 = b0.toByte(),
							b1 = if (output.idx + 1 < data.capacity()) data.get(
									output.idx + 1) else 0,
							b2 = if (output.idx + 2 < data.capacity()) data.get(
									output.idx + 2) else 0,
							b3 = if (output.idx + 3 < data.capacity()) data.get(
									output.idx + 3) else 0
					)
				}()
